        ...
        (i.prototype = {
          ...
          initDateFormatter: function() {
            var e = this,
              t = e.properties;
            t.date &&
              ((t.dateFormatter = new i.DateFormatter(t.datePattern)),
            ...
            return (
              ...
              r.phone
                ...
                ? (!r.prefix || (r.noImmediatePrefix && !e.length)
                    ...
                    : (r.result = r.prefix + r.numeralFormatter.format(e)),
                  void t.updateValueState())
    ...
    function(e, t) {
      ...
      var r = function(e, t, i, n, a, o, l) {
        ...
        (s.numeralDecimalMark = e || "."),
          (s.numeralIntegerScale = t > 0 ? t : 0),
          (s.numeralDecimalScale = i >= 0 ? i : 2),
          (s.numeralThousandsGroupStyle = n || r.groupStyle.thousand),
          (s.numeralPositiveOnly = !!a),
          (s.stripLeadingZeroes = o !== !1),
          (s.delimiter = l || "" === l ? l : ","),
          (s.delimiterRE = l ? new RegExp("\\" + l, "g") : "");
      };
      (r.groupStyle = {
        thousand: "thousand",
        lakh: "lakh",
        ...
        (r.prototype = {
          ...
          format: function(e) {
            ...
            switch (
              ...
              (i = e),
              e.indexOf(n.numeralDecimalMark) >= 0 &&
                ((t = e.split(n.numeralDecimalMark)),
                (i = t[0]),
                (a =
                  n.numeralDecimalMark + t[1].slice(0, n.numeralDecimalScale))),
              n.numeralIntegerScale > 0 &&
                (i = i.slice(
                  0,
                  n.numeralIntegerScale + ("-" === e.slice(0, 1) ? 1 : 0)
                )),
            ...
            return (
              i.toString() + (n.numeralDecimalScale > 0 ? a.toString() : "")
            );
          }
        }),
        (e.exports = r);
      ...
      var r = {
        ...
        getInfo: function(e, t) {
          ...
          for (var a in n)
            if (n[a].test(e)) {
              var o;
              return (o = t ? i.generalStrict : i[a]), { type: a, blocks: o };
            }
